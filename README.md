<sup>Compiled using https://landscape.cncf.io/</sup>
| |Repository|Stars|
|:---:|:---|:---:|
...
|29|[**microsoft/DeepSpeed**](https://github.com/microsoft/DeepSpeed)<br>DeepSpeed is a deep learning optimization library that makes distributed training and inference easy, efficient, and effective. - Apache License 2.0|32954<br><sup>(+32954)</sup>|
|30|[**docker/compose**](https://github.com/docker/compose)<br>Define and run multi-container applications with Docker - Apache License 2.0|32502<br><sup>(+69)</sup>|
|31|[**harness/gitness**](https://github.com/harness/gitness)<br>Gitness is an Open Source developer platform with Source Control management, Continuous Integration and Continuous Delivery. - Apache License 2.0|31536<br><sup>(+31)</sup>|
|32|[**ziglang/zig**](https://github.com/ziglang/zig)<br>General-purpose programming language and toolchain for maintaining robust, optimal, and reusable software. - MIT License|31058<br><sup>(+203)</sup>|
|33|[**hasura/graphql-engine**](https://github.com/hasura/graphql-engine)<br>Blazing fast, instant realtime GraphQL APIs on your DB with fine grained access control, also trigger webhooks on database events. - Apache License 2.0|30842<br><sup>(+5)</sup>|
|34|[**hashicorp/vault**](https://github.com/hashicorp/vault)<br>A tool for secrets management, encryption as a service, and privileged access management - Other|29764<br><sup>(+54)</sup>|
|35|[**cockroachdb/cockroach**](https://github.com/cockroachdb/cockroach)<br>CockroachDB - the open source, cloud-native distributed SQL database. - Other|29175<br><sup>(+44)</sup>|
|36|[**alibaba/nacos**](https://github.com/alibaba/nacos)<br>an easy-to-use dynamic service discovery, configuration and service management platform for building cloud native applications. - Apache License 2.0|29147<br><sup>(+63)</sup>|
|37|[**portainer/portainer**](https://github.com/portainer/portainer)<br>Making Docker and Kubernetes management easy. - zlib License|29063<br><sup>(+94)</sup>|
|38|[**apolloconfig/apollo**](https://github.com/apolloconfig/apollo)<br>Apollo is a reliable configuration management system suitable for microservice configuration management scenarios. - Apache License 2.0|28800<br><sup>(+9)</sup>|
|39|[**kubernetes/minikube**](https://github.com/kubernetes/minikube)<br>Run Kubernetes locally - Apache License 2.0|28445<br><sup>(+42)</sup>|
|40|[**OAI/OpenAPI-Specification**](https://github.com/OAI/OpenAPI-Specification)<br>The OpenAPI Specification Repository - Apache License 2.0|28321<br><sup>(+25)</sup>|
|41|[**hashicorp/consul**](https://github.com/hashicorp/consul)<br>Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure. - Other|27859<br><sup>(+17)</sup>|
|42|[**influxdata/influxdb**](https://github.com/influxdata/influxdb)<br>Scalable datastore for metrics, events, and real-time analytics - Apache License 2.0|27856<br><sup>(+44)</sup>|
|43|[**zeromicro/go-zero**](https://github.com/zeromicro/go-zero)<br>A cloud-native Go microservices framework with cli tool for productivity. - MIT License|27744<br><sup>(+60)</sup>|
|44|[**apache/kafka**](https://github.com/apache/kafka)<br>Mirror of Apache Kafka - Apache License 2.0|27470<br><sup>(+48)</sup>|
|45|[**milvus-io/milvus**](https://github.com/milvus-io/milvus)<br>A cloud-native vector database, storage for next generation AI applications - Apache License 2.0|27158<br><sup>(+27158)</sup>|
|46|[**k3s-io/k3s**](https://github.com/k3s-io/k3s)<br>Lightweight Kubernetes - Apache License 2.0|26597<br><sup>(+69)</sup>|
|47|[**backstage/backstage**](https://github.com/backstage/backstage)<br>Backstage is an open platform for building developer portals - Apache License 2.0|26555<br><sup>(+82)</sup>|
|48|[**rethinkdb/rethinkdb**](https://github.com/rethinkdb/rethinkdb)<br>The open-source database for the realtime web. - Other|26541<br><sup>(+7)</sup>|
|49|[**helm/helm**](https://github.com/helm/helm)<br>The Kubernetes Package Manager - Apache License 2.0|26099<br><sup>(+17)</sup>|
|50|[**llvm/llvm-project**](https://github.com/llvm/llvm-project)<br>The LLVM Project is a collection of modular and reusable compiler and toolchain technologies. - Other|25891<br><sup>(+152)</sup>|
|51|[**dmlc/xgboost**](https://github.com/dmlc/xgboost)<br>Scalable, Portable and Distributed Gradient Boosting (GBDT, GBRT or GBM) Library,  for Python, R, Java, Scala, C++ and more. Runs on single machine, Hadoop, Spark, Dask, Flink and DataFlow - Apache License 2.0|25622<br><sup>(+25622)</sup>|
|52|[**mongodb/mongo**](https://github.com/mongodb/mongo)<br>The MongoDB Database - Other|25528<br><sup>(+43)</sup>|
|53|[**emscripten-core/emscripten**](https://github.com/emscripten-core/emscripten)<br>Emscripten: An LLVM-to-WebAssembly Compiler - Other|25206<br><sup>(+24)</sup>|
|54|[**apache/incubator-seata**](https://github.com/apache/incubator-seata)<br>:fire: Seata is an easy-to-use, high-performance, open source distributed transaction solution. - Apache License 2.0|24960<br><sup>(+5)</sup>|
|55|[**openfaas/faas**](https://github.com/openfaas/faas)<br>OpenFaaS - Serverless Functions Made Simple - MIT License|24576<br><sup>(+21)</sup>|
|56|[**firecracker-microvm/firecracker**](https://github.com/firecracker-microvm/firecracker)<br>Secure and fast microVMs for serverless computing. - Apache License 2.0|24173<br><sup>(+28)</sup>|
|57|[**dragonflydb/dragonfly**](https://github.com/dragonflydb/dragonfly)<br>A modern replacement for Redis and Memcached - Other|24014<br><sup>(+80)</sup>|
|58|[**envoyproxy/envoy**](https://github.com/envoyproxy/envoy)<br>Cloud-native high-performance edge/middle/service proxy - Apache License 2.0|24008<br><sup>(+43)</sup>|
|59|[**gitlabhq/gitlabhq**](https://github.com/gitlabhq/gitlabhq)<br>GitLab CE Mirror  - Other|23613<br><sup>(+6)</sup>|
|60|[**grafana/k6**](https://github.com/grafana/k6)<br>A modern load testing tool, using Go and JavaScript - https://k6.io - GNU Affero General Public License v3.0|23502<br><sup>(+40)</sup>|
|61|[**dapr/dapr**](https://github.com/dapr/dapr)<br>Dapr is a portable, event-driven, runtime for building distributed applications across cloud and edge. - Apache License 2.0|23338<br><sup>(+20)</sup>|
...
|90|[**mlflow/mlflow**](https://github.com/mlflow/mlflow)<br>Open source platform for the machine learning lifecycle - Apache License 2.0|17389<br><sup>(+17389)</sup>|
...
|119|[**elastic/logstash**](https://github.com/elastic/logstash)<br>Logstash - transport and process your logs, events, or other data - Other|14018<br><sup>(+4)</sup>|
...
|152|[**cert-manager/cert-manager**](https://github.com/cert-manager/cert-manager)<br>Automatically provision and manage TLS certificates in Kubernetes - Apache License 2.0|11523<br><sup>(+29)</sup>|
...
|179|[**aws/serverless-application-model**](https://github.com/aws/serverless-application-model)<br>The AWS Serverless Application Model (AWS SAM) transform is a AWS CloudFormation macro that transforms SAM templates into CloudFormation templates. - Apache License 2.0|9248<br><sup>(+7)</sup>|
...
|206|[**uber/cadence**](https://github.com/uber/cadence)<br>Cadence is a distributed, scalable, durable, and highly available orchestration engine to execute asynchronous long-running business logic in a scalable and resilient way. - MIT License|7868<br><sup>(+35)</sup>|
...
|236|[**Alluxio/alluxio**](https://github.com/Alluxio/alluxio)<br>Alluxio, data orchestration for analytics and machine learning in the cloud - Apache License 2.0|6667<br><sup>(+11)</sup>|
...
|294|[**encoredev/encore**](https://github.com/encoredev/encore)<br>Encore is the Backend Development Platform purpose-built to help you create event-driven and distributed systems.  - Mozilla Public License 2.0|4810<br><sup>(+225)</sup>|
...
|324|[**litmuschaos/litmus**](https://github.com/litmuschaos/litmus)<br>Litmus helps  SREs and developers practice chaos engineering in a Cloud-native way. Chaos experiments are published at the ChaosHub  (https://hub.litmuschaos.io). Community notes is at https://hackmd.io/a4Zu_sH4TZGeih-xCimi3Q - Apache License 2.0|4205<br><sup>(+9)</sup>|
...
|350|[**apache/incubator-heron**](https://github.com/apache/incubator-heron)<br>Apache Heron (Incubating) is a realtime, distributed, fault-tolerant stream processing engine from Twitter - Apache License 2.0|3638|
...
|378|[**zalando/skipper**](https://github.com/zalando/skipper)<br>An HTTP router and reverse proxy for service composition, including use cases like Kubernetes Ingress - Other|3030<br><sup>(+9)</sup>|
...
|407|[**theforeman/foreman**](https://github.com/theforeman/foreman)<br>an application that automates the lifecycle of servers  - GNU General Public License v3.0|2511<br><sup>(+4)</sup>|
...
|437|[**kubesphere/kubekey**](https://github.com/kubesphere/kubekey)<br>Install Kubernetes/K3s only, both Kubernetes/K3s and KubeSphere, and related cloud-native add-ons, it supports all-in-one, multi-node, and HA 🔥 ⎈ 🐳 - Apache License 2.0|2115<br><sup>(+7)</sup>|
...
|466|[**kubeovn/kube-ovn**](https://github.com/kubeovn/kube-ovn)<br>A Bridge between SDN and Cloud Native (Project under CNCF) - Apache License 2.0|1833<br><sup>(+13)</sup>|
...
|469|[**nocalhost/nocalhost**](https://github.com/nocalhost/nocalhost)<br>Nocalhost is Cloud Native Dev Environment. - Other|1781<br><sup>(+5)</sup>|
|470|[**linki/chaoskube**](https://github.com/linki/chaoskube)<br>chaoskube periodically kills random pods in your Kubernetes cluster. - MIT License|1756|
|471|[**spring-cloud/spring-cloud-sleuth**](https://github.com/spring-cloud/spring-cloud-sleuth)<br>Distributed tracing for spring cloud - Apache License 2.0|1752<br><sup>(+1)</sup>|
|472|[**kapicorp/kapitan**](https://github.com/kapicorp/kapitan)<br>Generic templated configuration management for Kubernetes, Terraform and other things - Apache License 2.0|1748<br><sup>(+1)</sup>|
|473|[**cloudfoundry/cli**](https://github.com/cloudfoundry/cli)<br>The official command line client for Cloud Foundry - Apache License 2.0|1741<br><sup>(+1)</sup>|
|474|[**solo-io/squash**](https://github.com/solo-io/squash)<br>The debugger for microservices - Apache License 2.0|1736<br><sup>(+1)</sup>|
|475|[**parseablehq/parseable**](https://github.com/parseablehq/parseable)<br>Parseable is a log analytics system platform for modern, cloud native workloads - GNU Affero General Public License v3.0|1727<br><sup>(+10)</sup>|
|476|[**spiffe/spire**](https://github.com/spiffe/spire)<br>The SPIFFE Runtime Environment - Apache License 2.0|1679<br><sup>(+5)</sup>|
|477|[**Yelp/paasta**](https://github.com/Yelp/paasta)<br>An open, distributed platform as a service - Apache License 2.0|1670<br><sup>(+1)</sup>|
|478|[**Serverless-Devs/Serverless-Devs**](https://github.com/Serverless-Devs/Serverless-Devs)<br>:fire::fire::fire: Serverless Devs developer tool ( Serverless Devs 开发者工具 ) - Apache License 2.0|1669<br><sup>(+3)</sup>|
|479|[**apecloud/kubeblocks**](https://github.com/apecloud/kubeblocks)<br>KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s. - GNU Affero General Public License v3.0|1668<br><sup>(+19)</sup>|
|480|[**openyurtio/openyurt**](https://github.com/openyurtio/openyurt)<br>OpenYurt - Extending your native Kubernetes to edge(project under CNCF) - Apache License 2.0|1664<br><sup>(+2)</sup>|
|481|[**truera/trulens**](https://github.com/truera/trulens)<br>Evaluation and Tracking for LLM Experiments - MIT License|1659<br><sup>(+1659)</sup>|
|482|[**kptdev/kpt**](https://github.com/kptdev/kpt)<br>Automate Kubernetes Configuration Editing - Apache License 2.0|1643<br><sup>(+4)</sup>|
|483|[**headlamp-k8s/headlamp**](https://github.com/headlamp-k8s/headlamp)<br>A Kubernetes web UI that is fully-featured, user-friendly and extensible - Apache License 2.0|1641<br><sup>(+12)</sup>|
|484|[**runsidekick/sidekick**](https://github.com/runsidekick/sidekick)<br>Sidekick is no longer in service - GNU Affero General Public License v3.0|1633<br><sup>(+1)</sup>|
|485|[**yomorun/yomo**](https://github.com/yomorun/yomo)<br>🦖 Stateful Serverless Framework for building Geo-distributed Edge AI Infra - Apache License 2.0|1618<br><sup>(+4)</sup>|
|486|[**antrea-io/antrea**](https://github.com/antrea-io/antrea)<br>Kubernetes networking based on Open vSwitch - Apache License 2.0|1611<br><sup>(+6)</sup>|
|487|[**moosefs/moosefs**](https://github.com/moosefs/moosefs)<br>MooseFS – Open Source, Petabyte, Fault-Tolerant, Highly Performing, Scalable Network Distributed File System (Software-Defined Storage) - GNU General Public License v2.0|1593<br><sup>(+6)</sup>|
|488|[**carvel-dev/ytt**](https://github.com/carvel-dev/ytt)<br>YAML templating tool that works on YAML structure instead of text - Apache License 2.0|1591|
|489|[**theupdateframework/python-tuf**](https://github.com/theupdateframework/python-tuf)<br>Python reference implementation of The Update Framework (TUF) - Apache License 2.0|1587<br><sup>(+3)</sup>|
|490|[**kubefirst/kubefirst**](https://github.com/kubefirst/kubefirst)<br>The Kubefirst Open Source Platform - MIT License|1585<br><sup>(+57)</sup>|
|491|[**anchore/anchore-engine**](https://github.com/anchore/anchore-engine)<br>A service that analyzes docker images and scans for vulnerabilities - Apache License 2.0|1570<br><sup>(+2)</sup>|
|492|[**TritonDataCenter/smartos-live**](https://github.com/TritonDataCenter/smartos-live)<br>For more information, please see http://smartos.org/  For any questions that aren't answered there, please join the SmartOS discussion list: https://smartos.topicbox.com/groups/smartos-discuss |1553<br><sup>(+2)</sup>|
|493|[**kubeshop/monokle**](https://github.com/kubeshop/monokle)<br>Monokle is a set of OSS tools designed to help create and maintain high-quality Kubernetes configurations throughout the application lifecycle - MIT License|1552<br><sup>(+14)</sup>|
|494|[**apache/eventmesh**](https://github.com/apache/eventmesh)<br>EventMesh is a new generation serverless event middleware for building distributed event-driven applications. - Apache License 2.0|1551<br><sup>(+6)</sup>|
|495|[**openelb/openelb**](https://github.com/openelb/openelb)<br>Load Balancer Implementation for Kubernetes in Bare-Metal, Edge, and Virtualization - Apache License 2.0|1546<br><sup>(+7)</sup>|
|496|[**fluid-cloudnative/fluid**](https://github.com/fluid-cloudnative/fluid)<br>Fluid, elastic data abstraction and acceleration for BigData/AI applications in cloud. (Project under CNCF)  - Apache License 2.0|1537<br><sup>(+5)</sup>|
|497|[**artifacthub/hub**](https://github.com/artifacthub/hub)<br>Find, install and publish Cloud Native packages - Apache License 2.0|1531<br><sup>(+1)</sup>|
|498|[**siddhi-io/siddhi**](https://github.com/siddhi-io/siddhi)<br>Stream Processing and Complex Event Processing Engine - Apache License 2.0|1502<br><sup>(+2)</sup>|
|499|[**kyma-project/kyma**](https://github.com/kyma-project/kyma)<br>Kyma is an opinionated set of Kubernetes-based modular building blocks, including all necessary capabilities to develop and run enterprise-grade cloud-native applications. - Apache License 2.0|1502|
|500|[**grafeas/grafeas**](https://github.com/grafeas/grafeas)<br>Artifact Metadata API - Apache License 2.0|1502<br><sup>(+2)</sup>|
|501|[**kube-logging/logging-operator**](https://github.com/kube-logging/logging-operator)<br>Logging operator for Kubernetes - Apache License 2.0|1495<br><sup>(+7)</sup>|
|502|[**polardb/polardbx-sql**](https://github.com/polardb/polardbx-sql)<br>PolarDB-X is a cloud native distributed SQL Database designed for high concurrency, massive storage, complex querying scenarios. - Apache License 2.0|1488<br><sup>(+6)</sup>|
|503|[**dfinity/ic**](https://github.com/dfinity/ic)<br>Internet Computer blockchain source: the client/replica software run by nodes - Other|1476<br><sup>(+2)</sup>|
|504|[**chaitin/veinmind-tools**](https://github.com/chaitin/veinmind-tools)<br>veinmind-tools 是由长亭科技自研，基于 veinmind-sdk 打造的容器安全工具集 - MIT License|1474<br><sup>(+4)</sup>|
|505|[**vdaas/vald**](https://github.com/vdaas/vald)<br>Vald.  A Highly Scalable Distributed Vector Search Engine - Apache License 2.0|1466<br><sup>(+3)</sup>|
|506|[**projectcapsule/capsule**](https://github.com/projectcapsule/capsule)<br>Multi-tenancy and policy-based framework for Kubernetes. - Apache License 2.0|1463<br><sup>(+5)</sup>|
|507|[**kubeflow/training-operator**](https://github.com/kubeflow/training-operator)<br>Distributed ML Training and Fine-Tuning on Kubernetes - Apache License 2.0|1463<br><sup>(+1463)</sup>|
|508|[**NagiosEnterprises/nagioscore**](https://github.com/NagiosEnterprises/nagioscore)<br>Nagios Core - GNU General Public License v2.0|1456<br><sup>(+4)</sup>|
|509|[**OpenFunction/OpenFunction**](https://github.com/OpenFunction/OpenFunction)<br>Cloud Native Function-as-a-Service Platform (CNCF Sandbox Project) - Apache License 2.0|1454<br><sup>(+5)</sup>|
|510|[**agola-io/agola**](https://github.com/agola-io/agola)<br>Agola: CI/CD Redefined - Apache License 2.0|1446<br><sup>(+4)</sup>|
|511|[**kubeflow/katib**](https://github.com/kubeflow/katib)<br>Automated Machine Learning on Kubernetes - Apache License 2.0|1431<br><sup>(+1431)</sup>|
|512|[**apache/carbondata**](https://github.com/apache/carbondata)<br>High performance data store solution - Apache License 2.0|1421<br><sup>(+3)</sup>|
|513|[**AutoMQ/automq**](https://github.com/AutoMQ/automq)<br>AutoMQ is a cloud-native fork of Kafka by separating storage to S3. 10x cost-effective. Autoscale in seconds. Single-digit ms latency. - Other|1421<br><sup>(+1421)</sup>|
|514|[**FairwindsOps/rbac-manager**](https://github.com/FairwindsOps/rbac-manager)<br>A Kubernetes operator that simplifies the management of Role Bindings and Service Accounts. - Apache License 2.0|1415<br><sup>(+4)</sup>|
|515|[**spiffe/spiffe**](https://github.com/spiffe/spiffe)<br>The SPIFFE Project - Apache License 2.0|1408<br><sup>(+6)</sup>|
|516|[**Checkmk/checkmk**](https://github.com/Checkmk/checkmk)<br>Checkmk - Best-in-class infrastructure & application monitoring - GNU General Public License v2.0|1403<br><sup>(+30)</sup>|
|517|[**radius-project/radius**](https://github.com/radius-project/radius)<br>Radius is a cloud-native, portable application platform that makes app development easier for teams building cloud-native apps. - Apache License 2.0|1398<br><sup>(+1398)</sup>|
|518|[**lf-edge/ekuiper**](https://github.com/lf-edge/ekuiper)<br>Lightweight data stream processing engine for IoT edge - Apache License 2.0|1372<br><sup>(+7)</sup>|
|519|[**rancher/rke2**](https://github.com/rancher/rke2)<br>null - Apache License 2.0|1370<br><sup>(+13)</sup>|
|520|[**matanolabs/matano**](https://github.com/matanolabs/matano)<br>Open source security data lake for threat hunting, detection & response, and cybersecurity analytics at petabyte scale on AWS - Apache License 2.0|1360<br><sup>(+2)</sup>|
|521|[**motdotla/node-lambda**](https://github.com/motdotla/node-lambda)<br>Command line tool to locally run and deploy your node.js application to Amazon Lambda - BSD 2-Clause "Simplified" License|1344<br><sup>(+1)</sup>|
|522|[**aws/eks-distro**](https://github.com/aws/eks-distro)<br>Amazon EKS Distro (EKS-D) is a Kubernetes distribution based on and used by Amazon Elastic Kubernetes Service (EKS) to create reliable and secure Kubernetes clusters. - Apache License 2.0|1343<br><sup>(+6)</sup>|
|523|[**kcl-lang/kcl**](https://github.com/kcl-lang/kcl)<br>KCL Programming Language (CNCF Sandbox Project). https://kcl-lang.io - Apache License 2.0|1336<br><sup>(+9)</sup>|
|524|[**timescale/promscale**](https://github.com/timescale/promscale)<br>[DEPRECATED] Promscale is a unified metric and trace observability backend for Prometheus, Jaeger and OpenTelemetry built on PostgreSQL and TimescaleDB. - Apache License 2.0|1331|
|525|[**ManageIQ/manageiq**](https://github.com/ManageIQ/manageiq)<br>ManageIQ Open-Source Management Platform - Apache License 2.0|1331<br><sup>(+4)</sup>|
|526|[**traceloop/openllmetry**](https://github.com/traceloop/openllmetry)<br>Open-source observability for your LLM application, based on OpenTelemetry - Apache License 2.0|1318<br><sup>(+28)</sup>|
|527|[**mlrun/mlrun**](https://github.com/mlrun/mlrun)<br>MLRun is an open source MLOps platform for quickly building and managing continuous ML applications across their lifecycle. MLRun integrates into your development and CI/CD environment and automates the delivery of production data, ML pipelines, and online applications. - Apache License 2.0|1315<br><sup>(+1315)</sup>|
|528|[**pluralsh/plural**](https://github.com/pluralsh/plural)<br>Deploy open source software on Kubernetes in record time. 🚀 - Other|1313<br><sup>(+5)</sup>|
|529|[**clusternet/clusternet**](https://github.com/clusternet/clusternet)<br>[CNCF Sandbox Project] Managing your Kubernetes clusters (including public, private, edge, etc.) as easily as visiting the Internet - Apache License 2.0|1307<br><sup>(+7)</sup>|
|530|[**kubermatic/kubeone**](https://github.com/kubermatic/kubeone)<br>Kubermatic KubeOne automate cluster operations on all your cloud, on-prem, edge, and IoT environments.   - Apache License 2.0|1291<br><sup>(+2)</sup>|
|531|[**container-storage-interface/spec**](https://github.com/container-storage-interface/spec)<br>Container Storage Interface (CSI) Specification. - Apache License 2.0|1288<br><sup>(+2)</sup>|
|532|[**kubearmor/KubeArmor**](https://github.com/kubearmor/KubeArmor)<br>Runtime Security Enforcement System. Workload hardening/sandboxing and implementing least-permissive policies made easy leveraging LSMs (BPF-LSM, AppArmor). - Apache License 2.0|1282<br><sup>(+2)</sup>|
|533|[**OpenSCAP/openscap**](https://github.com/OpenSCAP/openscap)<br>NIST Certified SCAP 1.2 toolkit - GNU Lesser General Public License v2.1|1282<br><sup>(+2)</sup>|
|534|[**wasmCloud/wasmCloud**](https://github.com/wasmCloud/wasmCloud)<br>wasmCloud allows for simple, secure, distributed application development using WebAssembly components and capability providers. - Apache License 2.0|1277<br><sup>(+6)</sup>|
|535|[**oras-project/oras**](https://github.com/oras-project/oras)<br>OCI registry client - managing content like artifacts, images, packages - Apache License 2.0|1275<br><sup>(+7)</sup>|
|536|[**stashed/stash**](https://github.com/stashed/stash)<br>🛅 Backup your Kubernetes Stateful Applications - Other|1274<br><sup>(+1)</sup>|
|537|[**openclarity/kubeclarity**](https://github.com/openclarity/kubeclarity)<br>KubeClarity is a tool for detection and management of Software Bill Of Materials (SBOM) and vulnerabilities of container images and filesystems - Apache License 2.0|1263<br><sup>(+2)</sup>|
|538|[**skooner-k8s/skooner**](https://github.com/skooner-k8s/skooner)<br>Simple Kubernetes real-time dashboard and management. - Apache License 2.0|1254<br><sup>(+2)</sup>|
|539|[**kubeshop/testkube**](https://github.com/kubeshop/testkube)<br>☸️ Kubernetes-native testing framework for test execution and orchestration - Other|1223<br><sup>(+10)</sup>|
|540|[**fossas/fossa-cli**](https://github.com/fossas/fossa-cli)<br>Fast, portable and reliable dependency analysis for any codebase.  Supports license & vulnerability scanning for large monoliths.  Language-agnostic; integrates with 20+ build systems. - Mozilla Public License 2.0|1221<br><sup>(+1)</sup>|
|541|[**opstrace/opstrace**](https://github.com/opstrace/opstrace)<br>The Open Source Observability Distribution - Apache License 2.0|1214|
|542|[**Edgenesis/shifu**](https://github.com/Edgenesis/shifu)<br>Kubernetes-native IoT gateway - Apache License 2.0|1212<br><sup>(+8)</sup>|
|543|[**microcks/microcks**](https://github.com/microcks/microcks)<br>Kubernetes native tool for mocking and testing API and micro-services. Microcks is a Cloud Native Computing Foundation sandbox project 🚀 - Apache License 2.0|1209<br><sup>(+7)</sup>|
|544|[**koordinator-sh/koordinator**](https://github.com/koordinator-sh/koordinator)<br>A QoS-based scheduling system brings optimal layout and status to workloads such as microservices, web services, big data jobs, AI jobs, etc. - Apache License 2.0|1195<br><sup>(+9)</sup>|
|545|[**loggie-io/loggie**](https://github.com/loggie-io/loggie)<br>A lightweight, cloud-native data transfer agent and aggregator - Apache License 2.0|1193|
|546|[**openservicebrokerapi/servicebroker**](https://github.com/openservicebrokerapi/servicebroker)<br>Open Service Broker API Specification - Apache License 2.0|1186|
|547|[**kuasar-io/kuasar**](https://github.com/kuasar-io/kuasar)<br>A multi-sandbox container runtime that provides cloud-native, all-scenario multiple sandbox container solutions. - Apache License 2.0|1182<br><sup>(+1)</sup>|
|548|[**FDio/vpp**](https://github.com/FDio/vpp)<br>null - Apache License 2.0|1178<br><sup>(+4)</sup>|
|549|[**kudobuilder/kudo**](https://github.com/kudobuilder/kudo)<br>Kubernetes Universal Declarative Operator (KUDO) - Apache License 2.0|1163|
|550|[**OpenNebula/one**](https://github.com/OpenNebula/one)<br>The open source Cloud & Edge Computing Platform bringing real freedom to your Enterprise Cloud 🚀 - Apache License 2.0|1163<br><sup>(+1)</sup>|
|551|[**getporter/porter**](https://github.com/getporter/porter)<br>Porter enables you to package your application artifact, client tools, configuration and deployment logic together as an installer that you can distribute, and install with a single command. - Apache License 2.0|1158<br><sup>(+4)</sup>|
|552|[**elastic/apm-server**](https://github.com/elastic/apm-server)<br>APM Server - Other|1158<br><sup>(+2)</sup>|
|553|[**kubernetes-sigs/kueue**](https://github.com/kubernetes-sigs/kueue)<br>Kubernetes-native Job Queueing - Apache License 2.0|1157<br><sup>(+1157)</sup>|
|554|[**infinispan/infinispan**](https://github.com/infinispan/infinispan)<br>Infinispan is an open source data grid platform and highly scalable NoSQL cloud data store. - Apache License 2.0|1134<br><sup>(+5)</sup>|
|555|[**sermant-io/Sermant**](https://github.com/sermant-io/Sermant)<br>A Cloud-Native Proxyless Service Mesh based on  Java Bytecode Enhancement Technology - Apache License 2.0|1125<br><sup>(+1125)</sup>|
|556|[**percona/percona-server**](https://github.com/percona/percona-server)<br>Percona Server - Other|1100<br><sup>(+7)</sup>|
|557|[**sofastack/sofa-tracer**](https://github.com/sofastack/sofa-tracer)<br>SOFATracer is a component for the distributed system call trace. And through a unified traceId logging the logs of various network calls in the invoking link. These logs can be used for quick discovery of faults, service governance, etc. - Apache License 2.0|1090|
|558|[**hazelcast/hazelcast-jet**](https://github.com/hazelcast/hazelcast-jet)<br>Distributed Stream and Batch Processing - Other|1090|
|559|[**thomaspoignant/go-feature-flag**](https://github.com/thomaspoignant/go-feature-flag)<br>GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️ - MIT License|1083<br><sup>(+5)</sup>|
|560|[**stackrox/stackrox**](https://github.com/stackrox/stackrox)<br>The StackRox Kubernetes Security Platform performs a risk analysis of the container environment, delivers visibility and runtime alerts, and provides recommendations to proactively improve security by hardening the environment. - Apache License 2.0|1072|
|561|[**loft-sh/kiosk**](https://github.com/loft-sh/kiosk)<br>kiosk 🏢 Multi-Tenancy Extension For Kubernetes - Secure Cluster Sharing & Self-Service Namespace Provisioning - Apache License 2.0|1067|
|562|[**project-akri/akri**](https://github.com/project-akri/akri)<br>A Kubernetes Resource Interface for the Edge - Apache License 2.0|1062<br><sup>(+3)</sup>|
|563|[**aquasecurity/trivy-operator**](https://github.com/aquasecurity/trivy-operator)<br>Kubernetes-native security toolkit - Apache License 2.0|1062<br><sup>(+9)</sup>|
|564|[**servicemeshinterface/smi-spec**](https://github.com/servicemeshinterface/smi-spec)<br>Service Mesh Interface - Apache License 2.0|1051<br><sup>(+1)</sup>|
|565|[**gofr-dev/gofr**](https://github.com/gofr-dev/gofr)<br>An opinionated Go framework for accelerated microservice development - Apache License 2.0|1042<br><sup>(+67)</sup>|
|566|[**kubermatic/kubermatic**](https://github.com/kubermatic/kubermatic)<br>Kubermatic Kubernetes Platform - the Central Kubernetes Management Platform For Any Infrastructure  - Other|1031<br><sup>(+1)</sup>|
|567|[**genodelabs/genode**](https://github.com/genodelabs/genode)<br>Genode OS Framework - Other|1028<br><sup>(+3)</sup>|
|568|[**kubernetes-sigs/scheduler-plugins**](https://github.com/kubernetes-sigs/scheduler-plugins)<br>Repository for out-of-tree scheduler plugins based on scheduler framework. - Apache License 2.0|1020<br><sup>(+4)</sup>|
|569|[**CosmWasm/cosmwasm**](https://github.com/CosmWasm/cosmwasm)<br>Framework for building smart contracts in Wasm for the Cosmos SDK - Apache License 2.0|1019<br><sup>(+1)</sup>|
|570|[**spring-cloud/spring-cloud-function**](https://github.com/spring-cloud/spring-cloud-function)<br>null - Apache License 2.0|1018<br><sup>(+1)</sup>|
|571|[**deckhouse/deckhouse**](https://github.com/deckhouse/deckhouse)<br>Kubernetes platform from Flant - Other|1014<br><sup>(+3)</sup>|
|572|[**Metarget/metarget**](https://github.com/Metarget/metarget)<br>Metarget is a framework providing automatic constructions of vulnerable infrastructures. - Apache License 2.0|1012<br><sup>(+3)</sup>|
|573|[**neuvector/neuvector**](https://github.com/neuvector/neuvector)<br>null - Apache License 2.0|1009<br><sup>(+1)</sup>|
|574|[**sustainable-computing-io/kepler**](https://github.com/sustainable-computing-io/kepler)<br>Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe performance counters and other system stats, use ML models to estimate workload energy consumption based on these stats, and exports them as Prometheus metrics - Apache License 2.0|1007<br><sup>(+12)</sup>|
|575|[**superedge/superedge**](https://github.com/superedge/superedge)<br>An edge-native container management system for edge computing - Other|1007<br><sup>(+2)</sup>|
|576|[**screwdriver-cd/screwdriver**](https://github.com/screwdriver-cd/screwdriver)<br>An open source build platform designed for continuous delivery. - Other|1000<br><sup>(+1)</sup>|
|577|[**Authing/Authing**](https://github.com/Authing/Authing)<br>🔥Authing - IDaaS/IAM solution that can Auth to web and mobile applications. - MIT License|996<br><sup>(+2)</sup>|
|578|[**sensu/sensu-go**](https://github.com/sensu/sensu-go)<br>Simple. Scalable. Multi-cloud monitoring. - MIT License|985<br><sup>(+6)</sup>|
|579|[**aserto-dev/topaz**](https://github.com/aserto-dev/topaz)<br>Cloud-native authorization for modern applications and APIs - Apache License 2.0|982<br><sup>(+4)</sup>|
|580|[**containerd/runwasi**](https://github.com/containerd/runwasi)<br>Facilitates running Wasm / WASI workloads managed by containerd - Apache License 2.0|981<br><sup>(+1)</sup>|
|581|[**lucky-sideburn/kubeinvaders**](https://github.com/lucky-sideburn/kubeinvaders)<br>Gamified Chaos Engineering Tool for Kubernetes - Apache License 2.0|976<br><sup>(+1)</sup>|
|582|[**openGemini/openGemini**](https://github.com/openGemini/openGemini)<br>An open source distributed time-series database with high concurrency, high performance, and high scalability - Apache License 2.0|971<br><sup>(+7)</sup>|
|583|[**pipe-cd/pipecd**](https://github.com/pipe-cd/pipecd)<br>The One CD for All {applications, platforms, operations} - Apache License 2.0|967<br><sup>(+4)</sup>|
|584|[**schemahero/schemahero**](https://github.com/schemahero/schemahero)<br>A Kubernetes operator for declarative database schema management (gitops for database schemas) - Apache License 2.0|956<br><sup>(+3)</sup>|
|585|[**kairos-io/kairos**](https://github.com/kairos-io/kairos)<br>:penguin: The immutable Linux meta-distribution for edge Kubernetes. - Apache License 2.0|949<br><sup>(+4)</sup>|
|586|[**Netis/cloud-probe**](https://github.com/Netis/cloud-probe)<br>A Software Probe for network packet capturing and forwarding in Cloud/Kubernetes and Virtualized environment. - BSD 3-Clause "New" or "Revised" License|947|
|587|[**paralus/paralus**](https://github.com/paralus/paralus)<br>All-in-one Kubernetes access manager. User-level credentials, RBAC, SSO, audit logs. - Apache License 2.0|935<br><sup>(+4)</sup>|
|588|[**glasskube/glasskube**](https://github.com/glasskube/glasskube)<br>🧊 The next generation Package Manager for Kubernetes 📦 Featuring a GUI and a CLI. Glasskube packages are dependency aware, GitOps ready and can get automatic updates via a central public package repository. - Apache License 2.0|935<br><sup>(+53)</sup>|
|589|[**numaproj/numaflow**](https://github.com/numaproj/numaflow)<br>Kubernetes-native platform to run massively parallel data/streaming jobs - Apache License 2.0|923<br><sup>(+2)</sup>|
|590|[**bytecodealliance/wit-bindgen**](https://github.com/bytecodealliance/wit-bindgen)<br>A language binding generator for WebAssembly interface types - Apache License 2.0|897<br><sup>(+10)</sup>|
|591|[**kubeshop/tracetest**](https://github.com/kubeshop/tracetest)<br>🔭 Tracetest - Build integration and end-to-end tests in minutes, instead of days, using OpenTelemetry and trace-based testing. - Other|895<br><sup>(+4)</sup>|
|592|[**jreleaser/jreleaser**](https://github.com/jreleaser/jreleaser)<br>:rocket: Release projects quickly and easily with JReleaser - Apache License 2.0|891<br><sup>(+6)</sup>|
|593|[**couler-proj/couler**](https://github.com/couler-proj/couler)<br>Unified Interface for Constructing and Managing Workflows on different workflow engines, such as Argo Workflows, Tekton Pipelines, and Apache Airflow. - Apache License 2.0|890<br><sup>(+1)</sup>|
|594|[**kube-green/kube-green**](https://github.com/kube-green/kube-green)<br>A K8s operator to reduce CO2 footprint of your clusters - MIT License|887<br><sup>(+5)</sup>|
|595|[**replicatedhq/kots**](https://github.com/replicatedhq/kots)<br>KOTS provides the framework, tools and integrations that enable the delivery and management of 3rd-party Kubernetes applications, a.k.a. Kubernetes Off-The-Shelf (KOTS) Software. - Apache License 2.0|879|
|596|[**tinkerbell/tink**](https://github.com/tinkerbell/tink)<br>Workflow Engine for provisioning Bare Metal - Apache License 2.0|878<br><sup>(+4)</sup>|
|597|[**epsilla-cloud/vectordb**](https://github.com/epsilla-cloud/vectordb)<br>Epsilla is a high performance Vector Database Management System. Try out hosted Epsilla at https://cloud.epsilla.com/ - GNU General Public License v3.0|873<br><sup>(+1)</sup>|
|598|[**edgelesssys/constellation**](https://github.com/edgelesssys/constellation)<br>Constellation is the first Confidential Kubernetes. Constellation shields entire Kubernetes clusters from the (cloud) infrastructure using confidential computing. - GNU Affero General Public License v3.0|873<br><sup>(+2)</sup>|
|599|[**ray-project/kuberay**](https://github.com/ray-project/kuberay)<br>A toolkit to run Ray applications on Kubernetes - Apache License 2.0|869<br><sup>(+869)</sup>|
|600|[**AthenZ/athenz**](https://github.com/AthenZ/athenz)<br>Open source platform for X.509 certificate based service authentication and fine grained access control in dynamic infrastructures. Athenz supports provisioning and configuration (centralized authorization) use cases as well as serving/runtime (decentralized authorization) use cases. - Apache License 2.0|868<br><sup>(+4)</sup>|
|601|[**clastix/kamaji**](https://github.com/clastix/kamaji)<br>Kamaji is the Hosted Control Plane Manager for Kubernetes. - Apache License 2.0|864<br><sup>(+7)</sup>|
|602|[**open-gitops/project**](https://github.com/open-gitops/project)<br>Repository for top-level information about the OpenGitOps project - Other|860<br><sup>(+5)</sup>|
|603|[**datenlord/datenlord**](https://github.com/datenlord/datenlord)<br>DatenLord, Computing Defined Storage, an application-orientated, cloud-native distributed storage system - MIT License|854<br><sup>(+3)</sup>|
|604|[**devstream-io/devstream**](https://github.com/devstream-io/devstream)<br>DevStream: the open-source DevOps toolchain manager (DTM). - Apache License 2.0|842|
|605|[**apache/camel-k**](https://github.com/apache/camel-k)<br>Apache Camel K is a lightweight integration platform, born on Kubernetes, with serverless superpowers - Apache License 2.0|841<br><sup>(+10)</sup>|
|606|[**FairwindsOps/rbac-lookup**](https://github.com/FairwindsOps/rbac-lookup)<br>Easily find roles and cluster roles attached to any user, service account, or group name in your Kubernetes cluster - Apache License 2.0|840<br><sup>(+1)</sup>|
|607|[**in-toto/in-toto**](https://github.com/in-toto/in-toto)<br>in-toto is a framework to protect supply chain integrity. - Other|838<br><sup>(+7)</sup>|
|608|[**LINBIT/linstor-server**](https://github.com/LINBIT/linstor-server)<br>High Performance Software-Defined Block Storage for container, cloud and virtualisation. Fully integrated with Docker, Kubernetes, Openstack, Proxmox etc. - GNU General Public License v3.0|826<br><sup>(+3)</sup>|
|609|[**tremor-rs/tremor-runtime**](https://github.com/tremor-rs/tremor-runtime)<br>Main Tremor Project Rust Codebase - Apache License 2.0|822<br><sup>(+2)</sup>|
|610|[**sodafoundation/api**](https://github.com/sodafoundation/api)<br>SODA Terra Project API module : is an open source implementation of SODA API connecting storage to platforms like Kubernetes, OpenStack, and VMware - Apache License 2.0|822|
|611|[**nitrictech/nitric**](https://github.com/nitrictech/nitric)<br>Nitric is a multi-language framework for cloud applications with infrastructure from code. - Apache License 2.0|818<br><sup>(+4)</sup>|
|612|[**v6d-io/v6d**](https://github.com/v6d-io/v6d)<br>vineyard (v6d): an in-memory immutable data manager. (Project under CNCF, TAG-Storage) - Apache License 2.0|804<br><sup>(+1)</sup>|
|613|[**mosn/layotto**](https://github.com/mosn/layotto)<br>A fast and efficient cloud native application runtime - Apache License 2.0|801|
|614|[**project-copacetic/copacetic**](https://github.com/project-copacetic/copacetic)<br>🧵 CLI tool for directly patching container images using reports from vulnerability scanners - Apache License 2.0|799<br><sup>(+5)</sup>|
|615|[**k8gb-io/k8gb**](https://github.com/k8gb-io/k8gb)<br>A cloud native Kubernetes Global Balancer - Apache License 2.0|795<br><sup>(+4)</sup>|
|616|[**banzaicloud/koperator**](https://github.com/banzaicloud/koperator)<br>Oh no! Yet another Apache Kafka operator for Kubernetes - Apache License 2.0|770<br><sup>(+1)</sup>|
|617|[**clusterpedia-io/clusterpedia**](https://github.com/clusterpedia-io/clusterpedia)<br>The Encyclopedia of Kubernetes clusters - Apache License 2.0|763<br><sup>(+37)</sup>|
|618|[**project-zot/zot**](https://github.com/project-zot/zot)<br>zot - A production-ready vendor-neutral OCI-native container image/artifact registry (purely based on OCI Distribution Specification) - Apache License 2.0|755<br><sup>(+12)</sup>|
|619|[**apache/yunikorn-core**](https://github.com/apache/yunikorn-core)<br>Apache YuniKorn Core - Apache License 2.0|752<br><sup>(+752)</sup>|
|620|[**kubewharf/kubebrain**](https://github.com/kubewharf/kubebrain)<br>A High Performance Metadata System for Kubernetes - Apache License 2.0|739<br><sup>(+1)</sup>|
|621|[**KusionStack/kusion**](https://github.com/KusionStack/kusion)<br>Deliver intentions to Kubernetes and Clouds - Apache License 2.0|739|
|622|[**wa-lang/wa**](https://github.com/wa-lang/wa)<br>The Wa Programming Language: Simple, maintainable, compiled language for developing WebAssembly software - GNU Affero General Public License v3.0|733<br><sup>(+1)</sup>|
|623|[**opensergo/opensergo-specification**](https://github.com/opensergo/opensergo-specification)<br>Universal cloud-native microservice governance specification (微服务治理标准) - Apache License 2.0|731<br><sup>(+1)</sup>|
|624|[**aeraki-mesh/aeraki**](https://github.com/aeraki-mesh/aeraki)<br>Manage any layer-7 protocols in a Service Mesh. - Apache License 2.0|728<br><sup>(+4)</sup>|
|625|[**flomesh-io/pipy**](https://github.com/flomesh-io/pipy)<br>Pipy is a programmable proxy for the cloud, edge and IoT. - Other|727<br><sup>(+17)</sup>|
|626|[**cyberark/conjur**](https://github.com/cyberark/conjur)<br>CyberArk Conjur automatically secures secrets used by privileged users and machine identities - Other|727|
|627|[**merbridge/merbridge**](https://github.com/merbridge/merbridge)<br>Use eBPF to speed up your Service Mesh like crossing an Einstein-Rosen Bridge. - Apache License 2.0|726<br><sup>(+1)</sup>|
|628|[**secureCodeBox/secureCodeBox**](https://github.com/secureCodeBox/secureCodeBox)<br>secureCodeBox (SCB) - continuous secure delivery out of the box  - Other|724<br><sup>(+3)</sup>|
|629|[**openmessaging/openmessaging-java**](https://github.com/openmessaging/openmessaging-java)<br>OpenMessaging Runtime Interface for Java - Apache License 2.0|722<br><sup>(+1)</sup>|
|630|[**kanisterio/kanister**](https://github.com/kanisterio/kanister)<br>An extensible framework for  application-level data management on Kubernetes - Apache License 2.0|722|
|631|[**replicatedhq/kURL**](https://github.com/replicatedhq/kURL)<br>Production-grade, airgapped Kubernetes installer combining upstream k8s with overlays and popular components - Apache License 2.0|718<br><sup>(+1)</sup>|
|632|[**mweagle/Sparta**](https://github.com/mweagle/Sparta)<br>go microservices, powered by AWS Lambda - MIT License|718|
|633|[**curiefense/curiefense**](https://github.com/curiefense/curiefense)<br>Curiefense is a unified, open source platform protecting cloud native applications. - Apache License 2.0|715<br><sup>(+1)</sup>|
|634|[**open-telemetry/community**](https://github.com/open-telemetry/community)<br>OpenTelemetry community content - Apache License 2.0|701<br><sup>(+1)</sup>|
|635|[**serverlessworkflow/specification**](https://github.com/serverlessworkflow/specification)<br>Serverless Workflow Specification - Apache License 2.0|693<br><sup>(+2)</sup>|
|636|[**carina-io/carina**](https://github.com/carina-io/carina)<br>Carina: an high performance and ops-free local storage for kubernetes - Apache License 2.0|675<br><sup>(+2)</sup>|
|637|[**helmwave/helmwave**](https://github.com/helmwave/helmwave)<br>New 🌊 wave for @helm - MIT License|671<br><sup>(+2)</sup>|
|638|[**vscode-kubernetes-tools/vscode-kubernetes-tools**](https://github.com/vscode-kubernetes-tools/vscode-kubernetes-tools)<br>Kubernetes extension for Visual Studio Code - Apache License 2.0|663|
|639|[**kubewharf/kubezoo**](https://github.com/kubewharf/kubezoo)<br>a lightweight kubernetes multi-tenancy gateway - Apache License 2.0|656<br><sup>(+3)</sup>|
|640|[**l7mp/stunner**](https://github.com/l7mp/stunner)<br>A Kubernetes media gateway for WebRTC. Contact: info@l7mp.io - MIT License|649<br><sup>(+2)</sup>|
|641|[**opengauss-mirror/openGauss-server**](https://github.com/opengauss-mirror/openGauss-server)<br>openGauss kernel - Mulan Permissive Software License, Version 2|647|
|642|[**open-io/oio-sds**](https://github.com/open-io/oio-sds)<br>High Performance Software-Defined Object Storage for Big Data and AI, that supports Amazon S3 and Openstack Swift - Other|646<br><sup>(+2)</sup>|
|643|[**kubewharf/kubeadmiral**](https://github.com/kubewharf/kubeadmiral)<br>Multi-Cluster Kubernetes Orchestration - Apache License 2.0|640<br><sup>(+6)</sup>|
|644|[**openshift/microshift**](https://github.com/openshift/microshift)<br>A small form factor OpenShift/Kubernetes optimized for edge computing - Apache License 2.0|637<br><sup>(+3)</sup>|
|645|[**kubemq-io/kubemq-community**](https://github.com/kubemq-io/kubemq-community)<br>KubeMQ is a Kubernetes native message queue broker - Apache License 2.0|635<br><sup>(+1)</sup>|
|646|[**flatcar/Flatcar**](https://github.com/flatcar/Flatcar)<br>Flatcar project repository for issue tracking, project documentation, etc. - Apache License 2.0|635<br><sup>(+4)</sup>|
|647|[**gefyrahq/gefyra**](https://github.com/gefyrahq/gefyra)<br>Blazingly-fast :rocket:, rock-solid, local application development :arrow_right: with Kubernetes. - Apache License 2.0|632<br><sup>(+4)</sup>|
|648|[**ngrok/ngrok-go**](https://github.com/ngrok/ngrok-go)<br>Embed ngrok secure ingress into your Go apps as a net.Listener with a single line of code. - MIT License|625<br><sup>(+5)</sup>|
|649|[**teletrace/teletrace**](https://github.com/teletrace/teletrace)<br>Open-Source Tracing Platform - Apache License 2.0|617|
|650|[**travis-ci/travis-web**](https://github.com/travis-ci/travis-web)<br>The Ember web client for Travis CI - MIT License|613|
|651|[**cloud-ark/kubeplus**](https://github.com/cloud-ark/kubeplus)<br>Kubernetes Operator to create Kubernetes-native APIs from Helm charts for SaaS - Apache License 2.0|613<br><sup>(+3)</sup>|
|652|[**TritonDataCenter/manta**](https://github.com/TritonDataCenter/manta)<br>Manta is a scalable HTTP-based object store - Mozilla Public License 2.0|604<br><sup>(+1)</sup>|
|653|[**grycap/scar**](https://github.com/grycap/scar)<br>Serverless Container-aware ARchitectures (e.g. Docker in AWS Lambda) - Apache License 2.0|595|
|654|[**Accenture/reactive-interaction-gateway**](https://github.com/Accenture/reactive-interaction-gateway)<br>Create low-latency, interactive user experiences for stateless microservices. - Apache License 2.0|584<br><sup>(+1)</sup>|
|655|[**inclavare-containers/inclavare-containers**](https://github.com/inclavare-containers/inclavare-containers)<br>A novel container runtime, aka confidential container, for cloud-native confidential computing and enclave runtime ecosystem. - Apache License 2.0|574|
|656|[**megaease/easeagent**](https://github.com/megaease/easeagent)<br>An agent component for the Java system - Apache License 2.0|568|
|657|[**k8up-io/k8up**](https://github.com/k8up-io/k8up)<br>Kubernetes and OpenShift Backup Operator - Apache License 2.0|568<br><sup>(+2)</sup>|
|658|[**NexClipper/NexClipper**](https://github.com/NexClipper/NexClipper)<br>Metrics Pipeline for interoperability and Enterprise Prometheus - Apache License 2.0|562|
|659|[**PaladinCloud/CE**](https://github.com/PaladinCloud/CE)<br>Paladin Cloud is an extensible, cloud security platform for developers.  Join the community at https://discord.gg/xvCFD29Jj4 - Apache License 2.0|558<br><sup>(+2)</sup>|
|660|[**eunomia-bpf/eunomia-bpf**](https://github.com/eunomia-bpf/eunomia-bpf)<br>Build, Distribute and Run CO-RE eBPF programs easier with JSON and Webassembly OCI images - MIT License|556<br><sup>(+2)</sup>|
|661|[**apache/streampipes**](https://github.com/apache/streampipes)<br>Apache StreamPipes - A self-service (Industrial) IoT toolbox to enable non-technical users to connect, analyze and explore IoT data streams. - Apache License 2.0|552<br><sup>(+6)</sup>|
|662|[**open-feature/spec**](https://github.com/open-feature/spec)<br>OpenFeature specification - Apache License 2.0|549<br><sup>(+8)</sup>|
|663|[**uselagoon/lagoon**](https://github.com/uselagoon/lagoon)<br>Lagoon, the developer-focused application delivery platform - Apache License 2.0|543<br><sup>(+4)</sup>|
|664|[**scality/Zenko**](https://github.com/scality/Zenko)<br>Zenko is the open source multi-cloud data controller: own and keep control of your data on any cloud. - Apache License 2.0|543|
|665|[**kubedb/docs**](https://github.com/kubedb/docs)<br>KubeDB Docs - Apache License 2.0|534|
|666|[**metal3-io/baremetal-operator**](https://github.com/metal3-io/baremetal-operator)<br>Bare metal host provisioning integration for Kubernetes - Apache License 2.0|532<br><sup>(+2)</sup>|
|667|[**xline-kv/Xline**](https://github.com/xline-kv/Xline)<br>A geo-distributed KV store for metadata management - Apache License 2.0|529<br><sup>(+6)</sup>|
|668|[**cni-genie/CNI-Genie**](https://github.com/cni-genie/CNI-Genie)<br>CNI-Genie for choosing pod network of your choice during deployment time. Supported pod networks - Calico, Flannel, Romana, Weave  - Apache License 2.0|529<br><sup>(+1)</sup>|
|669|[**Keyfactor/ejbca-ce**](https://github.com/Keyfactor/ejbca-ce)<br>EJBCA® – Open-source public key infrastructure (PKI) and certificate authority (CA) software.  - GNU Lesser General Public License v2.1|529<br><sup>(+2)</sup>|
|670|[**Apicurio/apicurio-registry**](https://github.com/Apicurio/apicurio-registry)<br>An API/Schema registry - stores APIs and Schemas. - Apache License 2.0|528|
|671|[**FabEdge/fabedge**](https://github.com/FabEdge/fabedge)<br>Secure Edge Networking Solution Based On Kubernetes - Apache License 2.0|519<br><sup>(+1)</sup>|
|672|[**inlets/inlets-pro**](https://github.com/inlets/inlets-pro)<br>Secure HTTP and TCP tunnels that just work |518|
|673|[**vmware-tanzu/pinniped**](https://github.com/vmware-tanzu/pinniped)<br>Pinniped is the easy, secure way to log in to your Kubernetes clusters. - Apache License 2.0|514<br><sup>(+2)</sup>|
|674|[**tessi/wasmex**](https://github.com/tessi/wasmex)<br>Execute WebAssembly from Elixir - MIT License|512<br><sup>(+3)</sup>|
|675|[**hwameistor/hwameistor**](https://github.com/hwameistor/hwameistor)<br>Hwameistor is an HA local storage system for cloud-native stateful workloads.  - Apache License 2.0|512|
|676|[**megaease/easemesh**](https://github.com/megaease/easemesh)<br>A service mesh implementation for connecting,  control, and observe services in spring-cloud. - Apache License 2.0|508|
|677|[**vmware-labs/wasm-workers-server**](https://github.com/vmware-labs/wasm-workers-server)<br>🚀 Develop and run serverless applications on WebAssembly - Apache License 2.0|505<br><sup>(+5)</sup>|
|678|[**Normation/rudder**](https://github.com/Normation/rudder)<br>Rudder is a configuration and security automation platform. Manage your Cloud, hybrid or on-premises infrastructure in a simple, scalable and dynamic way. - GNU General Public License v3.0|496|
|679|[**apache/flink-statefun**](https://github.com/apache/flink-statefun)<br>Apache Flink Stateful Functions - Apache License 2.0|495|
|680|[**alibaba/kubeskoop**](https://github.com/alibaba/kubeskoop)<br>Network monitoring & diagnosis suite for Kubernetes - Apache License 2.0|495<br><sup>(+9)</sup>|
|681|[**updatecli/updatecli**](https://github.com/updatecli/updatecli)<br>A Declarative Dependency Management tool - Apache License 2.0|494<br><sup>(+5)</sup>|
|682|[**cloudtty/cloudtty**](https://github.com/cloudtty/cloudtty)<br>A Friendly Kubernetes CloudShell (Web Terminal) !  - MIT License|488<br><sup>(+4)</sup>|
|683|[**kubedl-io/kubedl**](https://github.com/kubedl-io/kubedl)<br>Run your deep learning workloads on Kubernetes more easily and efficiently. - Apache License 2.0|484<br><sup>(+2)</sup>|
|684|[**kubecube-io/KubeCube**](https://github.com/kubecube-io/KubeCube)<br>KubeCube is an open source enterprise-level container platform - Apache License 2.0|483<br><sup>(+1)</sup>|
|685|[**spidernet-io/spiderpool**](https://github.com/spidernet-io/spiderpool)<br>Underlay and RDMA network solution of the Kubernetes, for bare metal, VM and any public cloud - Apache License 2.0|479<br><sup>(+6)</sup>|
|686|[**cyclops-ui/cyclops**](https://github.com/cyclops-ui/cyclops)<br>customizable UI for Kubernetes workloads  👁️ - Apache License 2.0|477|
|687|[**openclarity/apiclarity**](https://github.com/openclarity/apiclarity)<br>An API security tool to capture and analyze API traffic, test API endpoints, reconstruct Open API specification, and identify API security risks.  - Apache License 2.0|476|
|688|[**cfengine/core**](https://github.com/cfengine/core)<br>CFEngine Community - Other|474|
|689|[**direktiv/direktiv**](https://github.com/direktiv/direktiv)<br>Serverless Container Orchestration - Apache License 2.0|465|
|690|[**loopholelabs/scale**](https://github.com/loopholelabs/scale)<br>A framework for building high-performance plugin systems into any application, powered by WebAssembly. - Apache License 2.0|464|
|691|[**teamcode-inc/kubeorbit**](https://github.com/teamcode-inc/kubeorbit)<br>Test your application on Kubernetes in a brand new simple way⚡ 轻量高效的微服务本地联调测试工具 - Apache License 2.0|459|
|692|[**parallaxsecond/parsec**](https://github.com/parallaxsecond/parsec)<br>Platform AbstRaction for SECurity service - Apache License 2.0|457|
|693|[**second-state/wasmedge-quickjs**](https://github.com/second-state/wasmedge-quickjs)<br>A high-performance, secure, extensible, and OCI-complaint JavaScript runtime for WasmEdge. - Apache License 2.0|454<br><sup>(+3)</sup>|
|694|[**kube-burner/kube-burner**](https://github.com/kube-burner/kube-burner)<br>Kubernetes performance and scale test orchestration framework written in golang - Apache License 2.0|453<br><sup>(+4)</sup>|
|695|[**kubewharf/kubegateway**](https://github.com/kubewharf/kubegateway)<br>Specific Layer7 Gateway for kube-apiserver - Apache License 2.0|451<br><sup>(+1)</sup>|
|696|[**hyscale/hyscale**](https://github.com/hyscale/hyscale)<br>HyScale is an Application Centric Abstraction Framework over K8s. - Apache License 2.0|445|
|697|[**hango-io/hango-gateway**](https://github.com/hango-io/hango-gateway)<br>Hango API Gateway, build on Envoy & Istio. - Apache License 2.0|445|
|698|[**vmware-tanzu/cartographer**](https://github.com/vmware-tanzu/cartographer)<br>Cartographer is a Supply Chain Choreographer. - Apache License 2.0|442|
|699|[**Juniper/contrail-controller**](https://github.com/Juniper/contrail-controller)<br>Contrail Controller - Apache License 2.0|441|
|700|[**scalar-labs/scalardb**](https://github.com/scalar-labs/scalardb)<br>Universal transaction manager - Apache License 2.0|439|
|701|[**sigstore/sigstore**](https://github.com/sigstore/sigstore)<br>Common go library shared across sigstore services and clients - Apache License 2.0|436<br><sup>(+1)</sup>|
|702|[**eraser-dev/eraser**](https://github.com/eraser-dev/eraser)<br>🧹 Cleaning up images from Kubernetes nodes - Apache License 2.0|436|
|703|[**Project-HAMi/HAMi**](https://github.com/Project-HAMi/HAMi)<br>Heterogeneous AI Computing Virtualization Middleware - Apache License 2.0|426<br><sup>(+11)</sup>|
|704|[**kubean-io/kubean**](https://github.com/kubean-io/kubean)<br> :seedling: Product ready cluster lifecycle management toolchains based on kubespray and other cluster LCM engine. - Apache License 2.0|425<br><sup>(+4)</sup>|
|705|[**armadaproject/armada**](https://github.com/armadaproject/armada)<br>A multi-cluster batch queuing system for high-throughput workloads on Kubernetes. - Apache License 2.0|423<br><sup>(+5)</sup>|
|706|[**razee-io/Razee**](https://github.com/razee-io/Razee)<br>Overview and docs - Apache License 2.0|421|
|707|[**mulesoft/mule**](https://github.com/mulesoft/mule)<br>Mule Community Edition - Other|421<br><sup>(+2)</sup>|
|708|[**slime-io/slime**](https://github.com/slime-io/slime)<br>An intelligent ServiceMesh manager based on Istio - Other|419|
|709|[**mewz-project/mewz**](https://github.com/mewz-project/mewz)<br>A unikernel designed specifically for running Wasm applications and compatible with WASI - GNU General Public License v3.0|419|
|710|[**foniod/foniod**](https://github.com/foniod/foniod)<br>Data first monitoring agent using (e)BPF, built on RedBPF - GNU General Public License v3.0|411|
|711|[**apioak/apioak**](https://github.com/apioak/apioak)<br>Full Lifecycle Management API Gateway. - Apache License 2.0|410|
|712|[**WebAssembly/wasi-nn**](https://github.com/WebAssembly/wasi-nn)<br>Neural Network proposal for WASI |408<br><sup>(+4)</sup>|
|713|[**seal-io/walrus**](https://github.com/seal-io/walrus)<br>Walrus is an open-source application management platform based on IaC tools including OpenTofu, Terraform and others. It helps platform engineers build golden paths for developers and empowers developers with self-service capabilities.  - Apache License 2.0|398<br><sup>(+5)</sup>|
|714|[**casper-network/casper-node**](https://github.com/casper-network/casper-node)<br>Reference client for CASPER protocol - Apache License 2.0|388|
|715|[**keylime/keylime**](https://github.com/keylime/keylime)<br>A CNCF Project to Bootstrap & Maintain Trust on the Edge / Cloud and IoT - Apache License 2.0|380<br><sup>(+2)</sup>|
|716|[**filecoin-project/ref-fvm**](https://github.com/filecoin-project/ref-fvm)<br>Reference implementation of the Filecoin Virtual Machine - Other|369|
|717|[**nokia/danm**](https://github.com/nokia/danm)<br>TelCo grade network management in a Kubernetes cluster - BSD 3-Clause "New" or "Revised" License|368<br><sup>(+2)</sup>|
|718|[**kubewharf/katalyst-core**](https://github.com/kubewharf/katalyst-core)<br>Katalyst aims to provide a universal solution to help improve resource utilization and optimize the overall costs in the cloud. This is the core components in Katalyst system, including multiple agents and centralized components - Apache License 2.0|360<br><sup>(+6)</sup>|
|719|[**piraeusdatastore/piraeus-operator**](https://github.com/piraeusdatastore/piraeus-operator)<br>The Piraeus Operator manages LINSTOR clusters in Kubernetes. - Apache License 2.0|350<br><sup>(+4)</sup>|
|720|[**openeuler-mirror/iSulad**](https://github.com/openeuler-mirror/iSulad)<br>[mirror]A light weight container runtime daemon for IOT and Cloud infrastructure. |350<br><sup>(+1)</sup>|
|721|[**NetEase-Media/easy-ngo**](https://github.com/NetEase-Media/easy-ngo)<br>easy-ngo是由网易传媒开发的基于Go语言的开发工具包，基于easy-ngo工具包，开发者可以快速构建高可用、大并发的应用。 - Apache License 2.0|350<br><sup>(+2)</sup>|
|722|[**microsoft/vscode-wasm**](https://github.com/microsoft/vscode-wasm)<br>A WASI implementation that uses VS Code's extension host as the implementing API - MIT License|341<br><sup>(+3)</sup>|
|723|[**openeuler-mirror/stratovirt**](https://github.com/openeuler-mirror/stratovirt)<br>null |337<br><sup>(+1)</sup>|
|724|[**kubewharf/godel-scheduler**](https://github.com/kubewharf/godel-scheduler)<br>a unified scheduler for online and offline tasks - Apache License 2.0|334<br><sup>(+334)</sup>|
|725|[**ortelius/ortelius**](https://github.com/ortelius/ortelius)<br>The mission of the Ortelius community is to expose weak links in the software supply chain by continuously gathering and analyzing software supply chain intelligence introduced across the DevOps pipeline and connected to your deployed environments. - Apache License 2.0|332<br><sup>(+1)</sup>|
|726|[**dispatchrun/timecraft**](https://github.com/dispatchrun/timecraft)<br>The WebAssembly Time Machine - GNU Affero General Public License v3.0|326|
|727|[**canonical/maas**](https://github.com/canonical/maas)<br>Official MAAS repository mirror (may be out of date). Development happens in Launchpad (https://git.launchpad.net/maas/). - Other|324<br><sup>(+1)</sup>|
|728|[**vmware-labs/webassembly-language-runtimes**](https://github.com/vmware-labs/webassembly-language-runtimes)<br>Wasm Language Runtimes provides popular language runtimes (Ruby, Python, …) precompiled to WebAssembly that are tested for compatibility and kept up to date when new versions of upstream languages are released - Apache License 2.0|316<br><sup>(+1)</sup>|
|729|[**darxkies/k8s-tew**](https://github.com/darxkies/k8s-tew)<br>Kubernetes - The Easier Way - GNU General Public License v3.0|307|
|730|[**deislabs/spiderlightning**](https://github.com/deislabs/spiderlightning)<br>A set of WIT definitions and associated implementations to enable app developers to work at a faster pace and require less knowledge of the environment in which they are executing. - MIT License|304|
|731|[**kubermatic/kubecarrier**](https://github.com/kubermatic/kubecarrier)<br>KubeCarrier - Service Management at Scale  - Apache License 2.0|299|
|732|[**3scale/APIcast**](https://github.com/3scale/APIcast)<br>3scale API Gateway - Apache License 2.0|298|
|733|[**notaryproject/notation**](https://github.com/notaryproject/notation)<br>A CLI tool to sign and verify artifacts - Apache License 2.0|291<br><sup>(+1)</sup>|
|734|[**wso2/product-microgateway**](https://github.com/wso2/product-microgateway)<br>Choreo Connect is a cloud-native, open-source, and developer-centric API gateway. - Apache License 2.0|283<br><sup>(+1)</sup>|
|735|[**service-mesh-performance/service-mesh-performance**](https://github.com/service-mesh-performance/service-mesh-performance)<br>Standardizing Service Mesh Value Measurement - Apache License 2.0|277|
|736|[**kubeclipper/kubeclipper**](https://github.com/kubeclipper/kubeclipper)<br>Manage kubernetes in the most light and convenient way ☸️ - Apache License 2.0|253<br><sup>(+1)</sup>|
|737|[**krkn-chaos/krkn**](https://github.com/krkn-chaos/krkn)<br>Chaos and resiliency testing tool for Kubernetes with a focus on improving performance under failure conditions. A CNCF sandbox project. - Apache License 2.0|252|
|738|[**cncf/landscapeapp**](https://github.com/cncf/landscapeapp)<br>🌄Upstream landscape generation application - Apache License 2.0|251|
|739|[**ligato/vpp-agent**](https://github.com/ligato/vpp-agent)<br>⚡️ Control plane management agent for FD.io's VPP - Apache License 2.0|249<br><sup>(+2)</sup>|
|740|[**kubeshop/kusk-gateway**](https://github.com/kubeshop/kusk-gateway)<br>Kusk-gateway is an OpenAPI-driven API Gateway for Kubernetes - MIT License|248|
|741|[**open-cluster-management-io/api**](https://github.com/open-cluster-management-io/api)<br>Core APIs for open cluster management - Apache License 2.0|243<br><sup>(+1)</sup>|
|742|[**keptn/lifecycle-toolkit**](https://github.com/keptn/lifecycle-toolkit)<br>Toolkit for cloud-native application lifecycle management - Apache License 2.0|242<br><sup>(+1)</sup>|
|743|[**devfile/api**](https://github.com/devfile/api)<br>Kube-native API for cloud development workspaces specification - Apache License 2.0|234|
|744|[**kubestellar/kubestellar**](https://github.com/kubestellar/kubestellar)<br>KubeStellar - a flexible solution for challenges associated with multi-cluster configuration management for edge, multi-cloud, and hybrid cloud - Apache License 2.0|227<br><sup>(+2)</sup>|
|745|[**gear-tech/gear**](https://github.com/gear-tech/gear)<br>Web3 Ultimate Execution Engine - GNU General Public License v3.0|222<br><sup>(+1)</sup>|
|746|[**couchbase/manifest**](https://github.com/couchbase/manifest)<br>Top-level source repository for Couchbase Server source code and build projects - Apache License 2.0|215|
|747|[**opcr-io/policy**](https://github.com/opcr-io/policy)<br>CLI for building OPA policies into OCI images - Apache License 2.0|203|
|748|[**knix-microfunctions/knix**](https://github.com/knix-microfunctions/knix)<br>Serverless computing platform with process-based lightweight function execution and container-based application isolation. Works in Knative and bare metal/VM environments. - Apache License 2.0|201|
|749|[**stacklok/minder**](https://github.com/stacklok/minder)<br>Software Supply Chain Security Platform - Apache License 2.0|198<br><sup>(+198)</sup>|
|750|[**saarasio/enroute**](https://github.com/saarasio/enroute)<br>EnRoute Ingress API Gateway - Kubernetes-native, Ingress API Gateway Powered using Envoy - Apache License 2.0|191|
|751|[**cybozu-go/cke**](https://github.com/cybozu-go/cke)<br>Cybozu Kubernetes Engine - Apache License 2.0|187<br><sup>(+2)</sup>|
|752|[**ipvm-wg/homestar**](https://github.com/ipvm-wg/homestar)<br>Homestar is the individual node that makes up the Everywhere Computer network (similar to how IPFS Kubo, Iroh, Nabu, or other implementation nodes make up the IPFS network). It's written in Rust and is designed for performance and composability. - Apache License 2.0|184<br><sup>(+3)</sup>|
|753|[**bytecodealliance/ComponentizeJS**](https://github.com/bytecodealliance/ComponentizeJS)<br>JS -> WebAssembly Component - Apache License 2.0|183<br><sup>(+1)</sup>|
|754|[**kubewarden/kubewarden-controller**](https://github.com/kubewarden/kubewarden-controller)<br>Manage admission policies in your Kubernetes cluster with ease - Apache License 2.0|177|
|755|[**project-stacker/stacker**](https://github.com/project-stacker/stacker)<br>Build OCI images natively from a declarative format - Apache License 2.0|173<br><sup>(+3)</sup>|
|756|[**architect/functions**](https://github.com/architect/functions)<br>AWS Lambda Node runtime helpers for Architect apps  |160|
|757|[**krator-rs/krator**](https://github.com/krator-rs/krator)<br>Kubernetes Rust State Machine Operator - Apache License 2.0|157|
|758|[**bytecodealliance/registry**](https://github.com/bytecodealliance/registry)<br>WebAssembly Registry (Warg) - Apache License 2.0|156<br><sup>(+3)</sup>|
|759|[**sighupio/fury-distribution**](https://github.com/sighupio/fury-distribution)<br>Kubernetes Fury Distribution (Core Modules) - A battle-tested open-source Kubernetes distribution - BSD 3-Clause "New" or "Revised" License|149|
|760|[**dylibso/observe-sdk**](https://github.com/dylibso/observe-sdk)<br>Continuous runtime observablity SDKs to monitor WebAssembly code. - Apache License 2.0|148|
|761|[**cloudify-cosmo/cloudify-manager**](https://github.com/cloudify-cosmo/cloudify-manager)<br>Cloudify's manager related code - Apache License 2.0|147|
|762|[**KWasm/kwasm-operator**](https://github.com/KWasm/kwasm-operator)<br>This Kubernetes Operators installs WebAssembly support on your Kubernetes Nodes - Apache License 2.0|147<br><sup>(+1)</sup>|
|763|[**charmed-kubernetes/bundle**](https://github.com/charmed-kubernetes/bundle)<br>Charmed Kubernetes bundles. Report bugs at https://bugs.launchpad.net/charmed-kubernetes - Apache License 2.0|143|
|764|[**gravitee-io/gravitee-api-management**](https://github.com/gravitee-io/gravitee-api-management)<br>Gravitee.io - OpenSource API Management - Apache License 2.0|142<br><sup>(+4)</sup>|
|765|[**digitalrebar/provision**](https://github.com/digitalrebar/provision)<br>Docs, API bindings, clients and integrations supporting RackN Digital Rebar data center provisioning and workflow system. - Other|136|
|766|[**confidential-containers/confidential-containers**](https://github.com/confidential-containers/confidential-containers)<br>Confidential Containers Community - Apache License 2.0|130<br><sup>(+2)</sup>|
|767|[**Azure/API-Management**](https://github.com/Azure/API-Management)<br>Repository with Azure API Management release notes. |130<br><sup>(+1)</sup>|
|768|[**wasmerio/vscode-wasm**](https://github.com/wasmerio/vscode-wasm)<br>WebAssembly extension for VSCode - MIT License|129|
|769|[**cdevents/spec**](https://github.com/cdevents/spec)<br>A common specification for Continuous Delivery events - Apache License 2.0|119|
|770|[**GoogleChromeLabs/asyncify**](https://github.com/GoogleChromeLabs/asyncify)<br>Standalone Asyncify helper for Binaryen - Apache License 2.0|116|
|771|[**wasmerio/wai**](https://github.com/wasmerio/wai)<br>A language binding generator for `wai` (a precursor to WebAssembly interface types) - Apache License 2.0|111|
|772|[**openeuler-mirror/nestos-kubernetes-deployer**](https://github.com/openeuler-mirror/nestos-kubernetes-deployer)<br>null - Apache License 2.0|104|
|773|[**embrace-io/embrace-apple-sdk**](https://github.com/embrace-io/embrace-apple-sdk)<br>The Embrace SDK in Swift - GNU Affero General Public License v3.0|101<br><sup>(+2)</sup>|
|774|[**TheLunarCompany/lunar**](https://github.com/TheLunarCompany/lunar)<br>lunar.dev: Ground Control for 3rd Party APIs - MIT License|99<br><sup>(+2)</sup>|
|775|[**dylibso/modsurfer**](https://github.com/dylibso/modsurfer)<br>Devtools to validate, audit and investigate WebAssembly binaries. - Apache License 2.0|97|
|776|[**hexa-org/policy-orchestrator**](https://github.com/hexa-org/policy-orchestrator)<br>Hexa Policy Orchestrator enables you to manage all of your access policies consistently across software providers. - Apache License 2.0|92|
|777|[**openclarity/vmclarity**](https://github.com/openclarity/vmclarity)<br>VMClarity is a tool for agentless detection and management of Virtual Machine Software Bill Of Materials (SBOM) and vulnerabilities - Apache License 2.0|86|
|778|[**streamsets/datacollector-oss**](https://github.com/streamsets/datacollector-oss)<br>datacollector-oss - Apache License 2.0|84|
|779|[**openshift/kubernetes**](https://github.com/openshift/kubernetes)<br>This is the repo that tracks all patches to the OpenShift distribution of Kubernetes on branches corresponding to OpenShift releases.  See https://github.com/openshift/kubernetes/blob/master/README.openshift.md for more - Apache License 2.0|76|
|780|[**centreon/centreon**](https://github.com/centreon/centreon)<br>Centreon is a network, system and application monitoring tool. Centreon is the only AIOps Platform Providing Holistic Visibility to Complex IT Workflows from Cloud to Edge. - Apache License 2.0|74<br><sup>(+1)</sup>|
|781|[**kyverno/kyverno-json**](https://github.com/kyverno/kyverno-json)<br>Kyverno for any JSON! |66<br><sup>(+66)</sup>|
|782|[**cisco-open/camblet**](https://github.com/cisco-open/camblet)<br>Fine-grained, zero-trust workload identity & access control​ - MIT License|62|
|783|[**alvistack/ansible-collection-kubernetes**](https://github.com/alvistack/ansible-collection-kubernetes)<br>Ansible collection for deploying Kubernetes - Apache License 2.0|55<br><sup>(+1)</sup>|
|784|[**airshipit/treasuremap**](https://github.com/airshipit/treasuremap)<br>Reference Airship manifests, CICD, and reference architecture. - Apache License 2.0|52|
|785|[**wasix-org/wasix-witx**](https://github.com/wasix-org/wasix-witx)<br>WebAssembly System Interface |50<br><sup>(+1)</sup>|
|786|[**projectsyn/commodore**](https://github.com/projectsyn/commodore)<br>Commodore provides opinionated tenant-aware management of Kapitan inventories and templates. Commodore uses Kapitan for the heavy lifting of rendering templates and resolving a hierachical configuration structure. - BSD 3-Clause "New" or "Revised" License|45|
|787|[**elastisys/compliantkubernetes-apps**](https://github.com/elastisys/compliantkubernetes-apps)<br>Elastisys Compliant Kubernetes is an open source, Certified Kubernetes distribution designed according to the ISO27001 controls: providing you with security tooling and observability from day one. - Apache License 2.0|44|
|788|[**flomesh-io/fsm**](https://github.com/flomesh-io/fsm)<br>Lightweight service mesh for Kubernetes East-West and North-South traffic management, uses ebpf for layer4  and pipy proxy for layer7 traffic management, support multi cluster network.  - Apache License 2.0|42<br><sup>(+1)</sup>|
|789|[**second-state/dapr-sdk-wasmedge**](https://github.com/second-state/dapr-sdk-wasmedge)<br>An experimental Dapr SDK in Rust. It is designed to run in WasmEdge applications. - Apache License 2.0|37|
|790|[**konveyor/operator**](https://github.com/konveyor/operator)<br>Konveyor Operator fully manages the deployment and life cycle of Konveyor (formerly Tackle) on Kubernetes and OpenShift. - Apache License 2.0|25|
|791|[**aserto-dev/runtime**](https://github.com/aserto-dev/runtime)<br>an abstraction library on top of OPA - Apache License 2.0|25|
|792|[**alvistack/vagrant-kubernetes**](https://github.com/alvistack/vagrant-kubernetes)<br>Vagrant Box Packaging for Kubernetes - Apache License 2.0|24|
|793|[**WebAssembly/wasi-logging**](https://github.com/WebAssembly/wasi-logging)<br>WASI logging API |18|
|794|[**starlingx/config**](https://github.com/starlingx/config)<br>StarlingX System Configuration Management - Apache License 2.0|16|
|795|[**shipwright-io/community**](https://github.com/shipwright-io/community)<br>Community documentation for Shipwright - Apache License 2.0|16|
|796|[**cloudmatos/matos**](https://github.com/cloudmatos/matos)<br>Matos is an open-source cloud security tool for analyzing multi-cloud infrastructure security. - MIT License|15|
|797|[**aceeric/desktop-kubernetes**](https://github.com/aceeric/desktop-kubernetes)<br>Stands up a multi-VM Kubernetes development cluster on your Linux desktop using VirtualBox or KVM, by running a single Bash script. A config yaml supports different cluster configs. - Apache License 2.0|14|
|798|[**second-state/witc**](https://github.com/second-state/witc)<br>wasm-interface-types supplement & compiler of wasmedge - Apache License 2.0|12|
|799|[**networkservicemesh/api**](https://github.com/networkservicemesh/api)<br>null - Apache License 2.0|12|
|800|[**EnterpriseDB/cloudnative-pg**](https://github.com/EnterpriseDB/cloudnative-pg)<br>CloudNativePG is a Kubernetes operator that covers the full lifecycle of a PostgreSQL database cluster with a primary/standby architecture, using native streaming replication - Apache License 2.0|12|
|801|[**mia-platform/distribution**](https://github.com/mia-platform/distribution)<br>Mia-Platform distribution for Kubernetes day two operation - Apache License 2.0|10|
|802|[**catalyst-cloud/magnum**](https://github.com/catalyst-cloud/magnum)<br>Container Infrastructure Management Service for OpenStack - Apache License 2.0|5|
|803|[**Wind-River/starlingx-config**](https://github.com/Wind-River/starlingx-config)<br>A github mirror of https://github.com/starlingx/config - Apache License 2.0|3|
|804|[**K-PaaS/container-platform**](https://github.com/K-PaaS/container-platform)<br>null - Apache License 2.0|3|
|805|[**kapetacom/kapeta**](https://github.com/kapetacom/kapeta)<br>Main entry repository - the gateway to everything else - MIT License|2|
|806|[**alexeadem/qbo-ce**](https://github.com/alexeadem/qbo-ce)<br>null - MIT License|1<br><sup>(+1)</sup>|
|807|[**null**](https://github.com/null)<br>null |0|
|808|[**null**](https://github.com/null)<br>null |0|
|809|[**null**](https://github.com/null)<br>null |0|

<sub>Last updated on 13/May/2024.</sub>
